class CraftNamantH_Potato_Mash extends RecipeBase
{
    override void Init()
    {
        m_Name = "Mash a potato in the pot to start making some moonshine";
        ...
        //result1
        AddResult("NamantH_Potato_Pot");//add results here
