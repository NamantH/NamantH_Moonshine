class CraftNamantH_Honey_Mash extends RecipeBase
{
    override void Init()
    {
        m_Name = "Add honey to the pot to make mash";
        ...
        //INGREDIENTS
        //ingredient 1
        InsertIngredient(0,"Honey");//you can insert multiple ingredients this way
        ...
        //result1
        AddResult("NamantH_Honey_Pot");//add results here
